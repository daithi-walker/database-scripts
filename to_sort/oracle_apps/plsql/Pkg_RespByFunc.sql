CREATE OR REPLACE PACKAGE Pkg_RespByFunc
AS
...
CREATE OR REPLACE PACKAGE BODY Pkg_RespByFunc
AS
   ...
   IS
      ...
      l_function_name   VARCHAR2(100) := 'GLXOCPER'; /*Open and Close Periods*/
      --l_function_name   VARCHAR2(100) := 'PERWSDJT'; /*Define Job*/
